...
<head>
  ...
  <style type="text/tailwindcss">
    .btn {
      @apply rounded-md px-2 py-1 text-center font-medium shadow-sm ring-1 ring-slate-700/10 text-slate-700 hover:bg-slate-100
    }
    .link {
      ...
      role="alert">
        ...
        <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            stroke="currentColor" class="h-6 w-6 cursor-pointer" @click="flash = flase">
